...
screenshots:
	...
	wb scroll up 1000
	sleep 1
	wb screenshot {{justfile_directory()}}/screenshots/demo-2-first-file.png
	@echo "📁 Step 3: Upload second file (sales data)"
	wb file-upload "input[type='file']" "{{justfile_directory()}}/demo/sales_data.csv"
	sleep 3
	wb scroll up 1000
	sleep 1
	wb screenshot {{justfile_directory()}}/screenshots/demo-3-two-files.png
	...
	wb scroll down 300
	sleep 1
	wb screenshot {{justfile_directory()}}/screenshots/demo-4-join-query.png
	@echo "⚡ Step 5: Execute JOIN and show results"
	wb click "#run-query"
	sleep 4
	wb scroll down 600
	sleep 1
	wb screenshot {{justfile_directory()}}/screenshots/demo-5-join-results.png
	@echo "📸 Legacy screenshots for compatibility"
	wb scroll up 1000
	sleep 1
	wb screenshot {{justfile_directory()}}/screenshots/app-ready.png
	wb screenshot {{justfile_directory()}}/screenshots/file-uploaded.png
	wb screenshot {{justfile_directory()}}/screenshots/query-results.png
